 ...
 * @author jdev1
 */
public class Edit_Progress_Information extends javax.swing.JFrame {
    ...
    public Edit_Progress_Information() {
        initComponents();
    }
    
    public Edit_Progress_Information(String classTextField) {
    ...
    private void initComponents() {
        ...
        percent_slider = new javax.swing.JSlider();
        ...
        enterClassStartDate_label.setText("Update Percentage Complete");
        ...
        getContentPane().add(submit_button, new org.netbeans.lib.awtextra.AbsoluteConstraints(306, 276, -1, -1));
        ...
        backToEditSchedule_button.setText("Back to Edit Progress");
        ...
        getContentPane().add(backToEditSchedule_button, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 276, -1, -1));

        percent_slider.setBackground(new java.awt.Color(23, 20, 20));
        percent_slider.setForeground(new java.awt.Color(242, 242, 242));
        getContentPane().add(percent_slider, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 164, 372, -1));
    ...
    private void submit_buttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_submit_buttonMouseClicked
        // TODO add your handling code here:
         ...
         ArrayListHandler.editPercentComplete(element, percent);
    ...
    private void backToEditSchedule_buttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_backToEditSchedule_buttonMouseClicked
        // TODO add your handling code here:
             Edit_Progress edit_schedule = new Edit_Progress();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_Progress_Information.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Edit_Progress_Information().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JSlider percent_slider;
